...
@register_tool(include_functions=["reply_to_human"])
class RoleZero(Role):
    ...
    special_tool_commands: list[str] = ["Plan.finish_current_task", "end", "Terminal.run_command"]
    ...
    def set_tool_execution(self) -> "RoleZero":
        ...
        self.tool_execution_map = {
            ...
            # "RoleZero.ask_human": self.ask_human,  # Disabled to prevent asking human
