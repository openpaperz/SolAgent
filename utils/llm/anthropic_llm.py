...
from .constants import get_service_config
...
class Anthropic(LLM):
    ...
    def _stream_format_output_message(self,
        ...
        tool_call_id_map = {}  # index -> tool_call_id (for deduplication yield)
...
if __name__ == '__main__':
    ...
    messages = [Message(role='user', content='Describe Hangzhou in 300 words')]
    # messages = [Message(role='user', content='What clothes should I bring to London now?')]
